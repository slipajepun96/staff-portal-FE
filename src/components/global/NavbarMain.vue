    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/" class="flex ms-2 md:me-24">
            <svg class="flex-shrink-0 w-7 h-7 text-gray-600 transition duration-75 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
               <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
            </svg>
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap ml-1">Portal Kakitangan</span>
        </a>
      </div>
      <div class="flex items-center">
          <div class="flex items-center ms-1">
            <div class="flex inline-flex">
               <!-- <div class="px-1 py-1" role="none">
                <p class="text-sm text-gray-900" role="none">
                  Umar Qayyum bin Zainal
                </p>
                <p class="text-sm font-medium text-gray-900 truncate " role="none">
                  umar.qayyum@pkppagro.com.my
                </p>
              </div> -->
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-300 rounded-lg shadow-xl" id="dropdown-user">
              ...
              <ul class="py-1" role="none">
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 " role="menuitem">Profil Akaun</a>
                </li>
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Tetapan</a>
                </li>

                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-700 hover:text-white" role="menuitem">Log Keluar</a>
                </li>
              </ul>
            </div>
          </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
      <ul class="space-y-2 font-medium">
         <li>
            <router-link to="/">
            <a href="#" class="flex items-center p-2 text-gray-900 hover:bg-gray-100 rounded-lg group">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 hover:bg-gray-100 rounded-lg group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Tuntutan</span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Kehadiran / Kerja Luar</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Kenderaan Syarikat</span>
            </a>
         </li>
         <li>
            <router-link to="/staff">
               <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap">Peribadi</span>
               </a>
            </router-link>
         </li>
